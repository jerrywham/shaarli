var inputsToFilter = $('input[data-multiple]');
inputsToFilter.each(function(i,v){
    var inpt = this;
    awesomplete = new Awesomplete(inpt, {
        filter: function(text, inpt) {
            return Awesomplete.FILTER_CONTAINS(text, inpt.match(/[^ ]*$/)[0]);
        },
