...
function hook_markdown_render_includes($data)
{
    ...
    if ($data['_PAGE_'] == Router::$PAGE_EDITLINK
        ...
        $data['css_files'][] = PluginManager::$PLUGINS_PATH . '/markdown/markdownhelp.css';
    }
...
function hook_markdown_render_editlink($data)
{
    ...
    $data['edit_link_plugin'][] = file_get_contents($ShaarliRoot.PluginManager::$PLUGINS_PATH .'/markdown/markdownhelp.html');
